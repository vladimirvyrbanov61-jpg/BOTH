"""Synthetic fault injection for anomaly labels."""
...
from simon3264.encoding import WORD_MASK

FaultMode = Literal["random", "flip", "swap", "xor", "identity", "wrong_rounds", "wrong_z"]
...
def random_blocks(
    ...
    """Uniform random 32-bit blocks, shape (n, 2) uint16 — non-cipher class."""
...
def corrupt_block(
    ...
    *,
    ...
    """Apply bit-flip, half-swap, or XOR mask anomalies (vectorized over batch)."""
...
def wrong_z_encrypt(
    ...
    return cipher.encrypt_variant(plaintext, key, z_index=z_index)
