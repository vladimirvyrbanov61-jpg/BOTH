#!/usr/bin/env python3
"""Train and evaluate neural distinguishers per round count (SPECK 32/64)."""
...
from speck3264.cipher import ROUNDS
...
def run_distinguisher_experiment(
    ...
    *,
    ...
    for r in rounds_list:
        if r > ROUNDS:
            print(f"\n[Distinguisher] skipping rounds={r} (> {ROUNDS})")
            continue
    ...
    try:
        ...
        ax[0].set_title("Neural distinguisher advantage vs Speck rounds")
...
def main(argv: Optional[list[str]] = None) -> None:
    parser = argparse.ArgumentParser(description="Neural distinguisher sweep over Speck rounds")
