"""PyTorch binary classifier for Simon neural distinguisher experiments."""
...
class NeuralDistinguisher:
    """MLP binary classifier: real Simon pair vs random pair."""
    ...
    def score_samples(self, X: np.ndarray) -> np.ndarray:
        """Probability of class 1 (real Simon pair)."""
