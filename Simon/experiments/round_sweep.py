#!/usr/bin/env python3
"""Track A: evaluate TorchAutoencoder scores across varying round counts."""
...
from simon3264.cipher import ROUNDS, Simon3264
...
def generate_round_dataset(
    ...
    """Return blocks (N,2) uint16 and labels (N,) — 0 if rounds==32 else 1."""
...
def run_round_sweep(
    ...
    *,
    ...
    for r in rounds_list:
        ...
        row = evaluate_round(
            model, threshold, cipher, r, rc.n_samples_per_round, rng
        )
        rows.append(row)
        print(
